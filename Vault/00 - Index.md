...
Hub note for the **Meal Prep / Recipe Tracking** practica project.
Open the graph view to see how everything connects.
...
- [[Sessions/2026-05-07 - Phase 2 - API Layer]]
...
4. Read [[Decisions Log]] for the why behind existing choices.
5. Resume.
